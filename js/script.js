...
function validatePick() {
    let selectedCrust = parseFloat(document.getElementById("cake-crust").value);
    let selectedToppings = parseFloat(document.getElementById("cake-toppings").value);
    let selectedSize = parseFloat(document.getElementById("cake-size").value);
    let quantity = document.getElementById("cakeNumber").value;
